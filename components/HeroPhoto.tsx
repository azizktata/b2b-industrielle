...
const SLIDES = [
  {
    ...
    body: "Purgeurs, détendeurs, séparateurs — distributeur agréé SAMSON, SAV certifié fabricant.",
  ...
  },
  {
    ...
    body: "Manomètres, thermomètres, transmetteurs iFm et Sferaco — gamme complète pour toutes conditions industrielles.",
  ...
  },
  {
    ...
    body: "Filtration, séchage, régulation de pression. Solutions MIVAL, ADCA pour réseaux industriels.",
